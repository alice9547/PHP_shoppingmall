...
<table width="959" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><a href="index.html"><img src="images/main_image3.gif" width="959" height="175" border="0"></a></td>
	</tr>
</table>
...
<table width="959" height="25" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td align="left" bgcolor="#F7F7F7">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><a href="product.php?menu=1"><img src="images/main_menu01_off.gif" width="155" height="30" border="0"  onmouseover="img_change('on')" onmouseout="img_change('off')"></a></td>
					<td><a href="product.php?menu=2"><img src="images/main_menu02_off.gif" width="155" height="30" border="0"  onmouseover="img_change('on')" onmouseout="img_change('off')"></a></td>
					<td><a href="product.php?menu=3"><img src="images/main_menu03_off.gif" width="155" height="30" border="0"  onmouseover="img_change('on')" onmouseout="img_change('off')"></a></td>
					<td><a href="product.php?menu=4"><img src="images/main_menu04_off.gif" width="155" height="30" border="0"  onmouseover="img_change('on')" onmouseout="img_change('off')"></a></td>
					<td><a href="product.php?menu=5"><img src="images/main_menu05_off.gif" width="155" height="30" border="0"  onmouseover="img_change('on')" onmouseout="img_change('off')"></a></td>
					<td><a href="product.php?menu=6"><img src="images/main_menu06_off.gif" width="155" height="30" border="0"  onmouseover="img_change('on')" onmouseout="img_change('off')"></a></td>
				</tr>
			</table>
		</td>
	</tr>
...
<table width="959" height="40" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr bgcolor="#F0F0F0">
		...
		&nbsp <b>반갑습니다 &nbsp;&nbsp
		<?
		if (!$cookie_no) echo("고객");
		else echo($cookie_name);
		?>
		님.
		
		</b></font></td>
		<td style="font-size:9pt;color:#666666;font-family:돋움;padding-left:5px;"></td>
		<td align="right" style="font-size:9pt;color:#666666;font-family:돋움;"><b>옷장 뒤져보기&nbsp </b></td>
		<!-- form1 시작 -->
		...
		<!-- form1 끝 -->
		<td width="30" align="center"><a href="javascript:Search()"><img src="images/i_search_logo.gif" border="0"></a></td>
	</tr>
	<tr><td height="1" colspan="5" bgcolor="black"></td></tr>
</table>
